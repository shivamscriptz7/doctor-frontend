...
// 'use client';
// // imports ke neeche yeh add karo
// import { useEffect, useRef } from 'react';
// import { useState } from 'react';
// import { useRouter } from 'next/navigation';
// import { Heart, Activity, Users, Shield, ArrowRight, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
// import { loginApi, signupApi } from '../lib/commonApis';
...
//     warning: { bg: '#fffbeb', border: '#fde68a', icon: '#d97706', bar: '#f59e0b', text: '#92400e' },
//   };
//   const c = colors[type];
...
//           setTimeout(() => router.push('/dashboard'), 1000); // toast dikhne ka time
//         } else {
...
//   //       if (res.access_token) {
//   //         // ✅ FIXED: Use 'access_token' key (matches AuthProvider)
//   //         localStorage.setItem('access_token', res.access_token);
//   //         localStorage.setItem('user', JSON.stringify(res.user));
//   //         alert('Login Successful');
...
// <div className="h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 flex flex-col items-center justify-center p-4 font-sans relative overflow-hidden">      {/* Animated background elements */}
//       <div className="absolute inset-0 overflow-hidden pointer-events-none">
//         <div className="absolute top-20 left-10 w-72 h-72 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
//         <div className="absolute top-40 right-10 w-72 h-72 bg-teal-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
//         <div className="absolute bottom-20 left-1/2 w-72 h-72 bg-cyan-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
...
// <div className="relative z-10 w-full max-w-6xl flex flex-col lg:flex-row bg-white rounded-3xl shadow-2xl overflow-hidden max-h-[92vh]">        <div className="lg:w-2/5 bg-gradient-to-br from-emerald-600 via-teal-600 to-teal-700 p-12 text-white relative overflow-hidden">
//           <div className="absolute inset-0 opacity-10" style={{
//             backgroundImage: 'radial-gradient(circle at 2px 2px, white 1px, transparent 0)',
//             backgroundSize: '40px 40px'
//           }}></div>
...
//           Powered by{' '}
//           <span className="font-semibold text-emerald-600">MediCare HMS</span>
...
import { useState } from 'react';
import { useRouter } from 'next/navigation';
import { Heart, Activity, Users, Shield, ArrowRight, Zap } from 'lucide-react';
import { loginApi, signupApi } from '../lib/commonApis';
...
export default function HospitalAuth() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 flex flex-col items-center justify-center p-4 font-sans relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
        <div className="absolute top-40 right-10 w-72 h-72 bg-teal-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
      ...
      <div className="relative z-10 w-full max-w-6xl flex flex-col lg:flex-row bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-6 mt-8 lg:mt-12">
                <h2 className="text-3xl lg:text-4xl font-bold leading-tight mb-6" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
                  Empowering Healthcare Professionals
                </h2>
            ...
            <div className="space-y-4 mt-8 lg:mt-12">
              ...
              {/* Powered by - Left Panel (visible on desktop inside card) */}
              <div className="hidden lg:flex items-center mt-6 pt-6 border-t border-white/20">
                <Zap className="w-3.5 h-3.5 text-emerald-200 mr-1.5" />
                <span className="text-emerald-100 text-xs">
                  Powered by{' '}
                  <span className="font-semibold text-white">MediCare Tech Solutions</span>
                </span>
              </div>
            </div>
          </div>
        ...
        {/* Right Panel - Form */}
        <div className="lg:w-3/5 p-8 sm:p-12 lg:p-16 flex flex-col justify-between">
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="mb-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
                {isLogin ? 'Welcome Back' : 'Create Account'}
              </h2>
              <p className="text-slate-600">
                {isLogin ? 'Enter your credentials to access your account' : 'Register to start managing healthcare operations'}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {!isLogin && (
                <div className="relative">
                  ...
                  <input
                    ...
                    onBlur={() => setFocusedField(null)}
                    placeholder="Dr. John Smith"
                    className={`w-full px-4 py-3.5 bg-slate-50 border-2 placeholder-slate-400 rounded-xl focus:outline-none transition-all duration-300 ${focusedField === 'fullName' ? 'border-emerald-500 bg-white shadow-lg shadow-emerald-100' : 'border-transparent hover:border-slate-200'}`}
                    required
                  />
                </div>
              )}
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  placeholder="doctor@hospital.com"
                  className={`w-full px-4 py-3.5 bg-slate-50 border-2 placeholder-slate-400 rounded-xl focus:outline-none transition-all duration-300 ${focusedField === 'email' ? 'border-emerald-500 bg-white shadow-lg shadow-emerald-100' : 'border-transparent hover:border-slate-200'}`}
                  required
                />
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  placeholder="••••••••"
                  className={`w-full px-4 py-3.5 bg-slate-50 border-2 placeholder-slate-400 rounded-xl focus:outline-none transition-all duration-300 ${focusedField === 'password' ? 'border-emerald-500 bg-white shadow-lg shadow-emerald-100' : 'border-transparent hover:border-slate-200'}`}
                  required
                />
              </div>
                ...
                <>
                  <div className="relative">
                    ...
                    <button
                      ...
                      onClick={() => setIsRoleOpen(!isRoleOpen)}
                      onBlur={() => setTimeout(() => setIsRoleOpen(false), 150)}
                      className={`w-full px-4 py-3.5 bg-slate-50 border-2 rounded-xl text-left font-medium flex items-center justify-between focus:outline-none transition-all duration-300 ${focusedField === 'role' ? 'border-emerald-500 bg-white shadow-lg shadow-emerald-100' : 'border-transparent hover:border-slate-200'}`}
                    >
                      <span className={formData.role ? 'text-slate-700' : 'text-slate-400'}>
                        {roles.find(r => r.value === formData.role)?.label || 'Select your role'}
                      </span>
                      <svg className={`w-4 h-4 text-emerald-600 transition-transform ${isRoleOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                      </svg>
                    </button>
                    {isRoleOpen && (
                      <div className="absolute z-20 mt-2 w-full overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl">
                        {roles.map((role) => (
                          <div
                            key={role.value}
                            onMouseDown={() => { setFormData(prev => ({ ...prev, role: role.value })); setIsRoleOpen(false); }}
                            className={`px-4 py-3 cursor-pointer transition-all ${formData.role === role.value ? 'bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold' : 'text-slate-700 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-teal-600 hover:text-white'}`}
                          >
                            {role.label}
                          </div>
                        ))}
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onBlur={() => setFocusedField(null)}
                      placeholder="HSP-12345"
                      className={`w-full px-4 py-3.5 bg-slate-50 border-2 placeholder-slate-400 rounded-xl focus:outline-none transition-all duration-300 ${focusedField === 'hospitalId' ? 'border-emerald-500 bg-white shadow-lg shadow-emerald-100' : 'border-transparent hover:border-slate-200'}`}
                      required
                    />
                  </div>
                </>
              ...
              {isLogin && (
                <div className="flex items-center justify-between text-sm">
                  <label className="flex items-center cursor-pointer group">
                    <input type="checkbox" className="w-4 h-4 text-emerald-600 border-slate-300 rounded focus:ring-2 focus:ring-emerald-500 cursor-pointer" />
            ...
            {isLogin && (
              <div className="mt-8 text-center">
                <p className="text-slate-600">
                  Don't have an account?{' '}
                  <button type="button" onClick={() => setIsLogin(false)} className="text-emerald-600 hover:text-emerald-700 font-semibold">
                    Sign up here
                  </button>
                </p>
              </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mt-5 flex flex-col sm:flex-row items-center justify-between gap-2 px-2">
        ...
        <p className="text-xs text-slate-500 text-center sm:text-left">
          © {currentYear} <span className="font-semibold text-slate-600">MediCare Hospital Management</span>. All rights reserved.
        </p>
