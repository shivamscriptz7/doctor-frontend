...
//     if (sortConfig.key) {
//       sortablePatients.sort((a:any, b:any) => {
...
//               <p className="text-sm text-slate-600 italic">Advanced filters coming soon...</p>
//             </div>
//           )}
//         </div>
...
//                   </span>{' '}
//                   of <span className="font-semibold text-slate-800">{filteredPatients.length}</span> results
//                 </p>
